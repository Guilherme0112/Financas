    ...
    <Modal :show="show" @close="emit('close')">
        <div class="p-6 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select v-model="form.tipo"
                        ...
                        required>
                        <option v-for="cat in tipo" :key="cat.value" :value="cat.value">
                            {{ cat.label }}
                        </option>
                    </select>
            ...
            <div class="mt-3 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <InputLabel :value="labelParaDataReferencia(form.tipo)" />
            ...
            <div v-if="mostrarCampoMetas(form.tipo)">
                <InputLabel value="Escolha a meta que deseja alocar o dinheiro" />
                <AutoSelect @update:query="(e) => buscarMetasComDebounce(e)" v-model="props.form.meta_id" :options="metasOptions" placeholder="Selecione a meta" />
            </div>
