...
<template>
    <div class="bg-white rounded-2xl shadow-lg p-6 space-y-4">
        <HeaderSecao
            ...
            description="Planeje seus sonhos e veja quanto precisa poupar."
        ...
        <div>
            <div
                ...
                v-if="props.metas.data.length > 0"
            >
                <CardMeta
                    v-for="meta in props.metas.data"
                    :key="meta.id"
                    :meta="meta"
                    :actions="true"
                    @click="editarMeta(meta)"
                    @delete="deletarMeta(meta.id)"
                />
            </div>
            <div v-else>
                <SemRegistro />
        ...
        <div class="w-full flex justify-end">
            <Paginacao
                :pagination="props.metas"
                routeName="limites.index"
                param="pageMeta"
            />
        </div>
    </div>
